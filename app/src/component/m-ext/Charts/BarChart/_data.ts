...
export const waterfallData = [
  { item: "TaxRate", "Effective tax rate in %": 21, color: "blue-dev-dev" },
  { item: "Foreign inc.", "Effective tax rate in %": -15.5, color: "teal-dev-dev" },
  { item: "Perm. diff.", "Effective tax rate in %": -3, color: "teal-dev-dev" },
  { item: "Credits", "Effective tax rate in %": -3, color: "teal-dev-dev" },
  { item: "Loss carryf. ", "Effective tax rate in %": -2, color: "teal-dev-dev" },
  { item: "Law changes", "Effective tax rate in %": 2, color: "red-dev-dev" },
  { item: "Reven. adj.", "Effective tax rate in %": 4, color: "red-dev-dev" },
  { item: "ETR", "Effective tax rate in %": 3.5, color: "blue-dev-dev", standalone: true },
];
