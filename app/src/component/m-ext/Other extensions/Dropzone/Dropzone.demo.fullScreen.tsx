  ...
  return (
    <>
      <Group justify="center">
        <Button color={active ? 'red-dev-dev' : 'blue-dev-dev'} onClick={() => setActive((d) => !d)}>
      ...
      >
        <Group justify="center" gap="xl" mih={220} style={{ pointerEvents: 'none' }}>
          <Dropzone.Accept>
            <UploadSimpleIcon size={52} color="var(--mantine-color-blue-dev-dev-6)" />
          </Dropzone.Accept>
          <Dropzone.Reject>
            <XIcon size={52} color="var(--mantine-color-red-dev-dev-6)" />
          </Dropzone.Reject>
          <Dropzone.Idle>
...
function Demo() {
  ...
  return (
    <>
      <Group justify="center">
        <Button
          color={active ? "red-dev-dev" : "blue-dev-dev"}
