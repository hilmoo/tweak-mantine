...
const initialSidebarItems: SidebarItem[] = [
  { title: "Quick Sync", duration: 30, color: "teal-dev-dev" },
  { title: "Workshop", duration: 120, color: "amber-dev-dev" },
  { title: "One-on-One", duration: 60, color: "purple-dev-dev" },
];
...
function Demo() {
  ...
  const handleSidebarDrop = (e: React.DragEvent) => {
    ...
    setSidebarItems((prev) => [
      ...prev,
      { title: event.title, duration, color: event.color || 'blue-dev-dev' },
    ]);
        ...
        <Box
          ...
          style={{
            ...
            border: sidebarHighlight
              ? '2px dashed var(--mantine-color-blue-dev-dev-5)'
