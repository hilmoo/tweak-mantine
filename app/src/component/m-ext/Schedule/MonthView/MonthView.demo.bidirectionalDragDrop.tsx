...
const initialSidebarItems: SidebarItem[] = [
  { title: "Team Offsite", color: "teal-dev-dev" },
  { title: "Release Day", color: "amber-dev-dev" },
  { title: "All Hands", color: "purple-dev-dev" },
];
...
function Demo() {
  ...
  const handleSidebarDrop = (e: React.DragEvent) => {
    ...
    setSidebarItems((prev) => [
      ...prev,
      { title: event.title, color: event.color || 'blue-dev-dev' },
    ]);
