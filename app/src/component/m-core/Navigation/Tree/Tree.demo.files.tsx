...
.leaf {
  ...
  &[data-selected] {
    font-weight: 700;
    background-color: var(--mantine-color-blue-dev-dev-light) !important;
...
function FileIcon({ name, isFolder, expanded }: FileIconProps) {
  ...
  if (isFolder) {
    return expanded ? (
      <FolderOpenIcon color="var(--mantine-color-amber-dev-dev-9)" size={14} />
    ) : (
      <FolderSimpleIcon color="var(--mantine-color-amber-dev-dev-9)" size={14} />
    );
  }
