...
function Demo() {
  ...
  return (
    <Stack align="center">
      <Group>
        <Badge color="blue-dev-dev">Top: {topReached}</Badge>
        <Badge color="green-dev-dev">Bottom: {bottomReached}</Badge>
        <Badge color="amber-dev-dev">Left: {leftReached}</Badge>
        <Badge color="green-dev-dev">Right: {rightReached}</Badge>
      </Group>
