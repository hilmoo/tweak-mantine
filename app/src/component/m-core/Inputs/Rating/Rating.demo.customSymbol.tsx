...
const getFullIcon = (value: number) => {
  switch (value) {
    case 1:
      return <SmileySadIcon style={getIconStyle('red-dev-dev')} />;
    case 2:
      return <SmileyNervousIcon style={getIconStyle('amber-dev-dev')} />;
    case 3:
      return <SmileyIcon style={getIconStyle('amber-dev-dev')} />;
    case 4:
      return <SmileyMehIcon style={getIconStyle('green-dev-dev')} />;
    case 5:
      return <SmileyWinkIcon style={getIconStyle('green-dev-dev')} />;
    default:
      return null;
  }
};
