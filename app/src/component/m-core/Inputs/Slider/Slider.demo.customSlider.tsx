...
.empty {
  ...
  border-radius: var(--mantine-radius-md);
  background-color: var(--mantine-color-gray-dev-dev-1);
  display: flex;
  align-items: center;
  padding-inline: 10px;
  ...
  @mixin dark {
    background-color: var(--mantine-color-gray-dev-dev-6);
  }
}
...
.thumb {
  ...
  border: 1px solid var(--mantine-color-gray-dev-dev-2);
  border-radius: var(--mantine-radius-md);
  height: 100%;
  ...
  color: var(--mantine-color-gray-dev-dev-5);

  @mixin dark {
    background-color: var(--mantine-color-gray-dev-dev-6);
    border-color: var(--mantine-color-gray-dev-dev-4);
    color: var(--mantine-color-gray-dev-dev-0);
  }
}
