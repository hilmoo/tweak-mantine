...
const cssCode = `.root {
  position: relative;
  background-color: light-dark(var(--mantine-color-gray-dev-dev-0), var(--mantine-color-gray-dev-dev-8));
  width: fit-content;
...
.indicator {
  background-color: light-dark(var(--mantine-color-white), var(--mantine-color-gray-dev-dev-6));
  border-radius: var(--mantine-radius-md);
  box-shadow: var(--mantine-shadow-md);
  border: 1px solid light-dark(var(--mantine-color-gray-dev-dev-2), var(--mantine-color-gray-dev-dev-4));
}
...
.control {
  ...
  color: light-dark(var(--mantine-color-gray-dev-dev-6), var(--mantine-color-gray-dev-dev-2));
  border-radius: var(--mantine-radius-md);
  ...
  @mixin hover {
    color: light-dark(var(--mantine-color-black), var(--mantine-color-white));
    background-color: light-dark(var(--mantine-color-gray-dev-dev-1), var(--mantine-color-gray-dev-dev-7));
  }
