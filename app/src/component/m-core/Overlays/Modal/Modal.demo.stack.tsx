      ...
      <Modal.Stack>
        <Modal {...stack.register('delete-page')} title="Delete this page?">
          ...
          <Group mt="lg" justify="flex-end">
            ...
            <Button onClick={() => stack.open('confirm-action')} color="red-dev-dev">
              Delete
            </Button>
          </Group>
        </Modal>
        ...
        <Modal {...stack.register('confirm-action')} title="Confirm action">
          ...
          <Group mt="lg" justify="flex-end">
            ...
            <Button onClick={() => stack.open('really-confirm-action')} color="red-dev-dev">
              Confirm
            </Button>
          </Group>
        </Modal>
        ...
        <Modal {...stack.register('really-confirm-action')} title="Really confirm action">
          ...
          <Group mt="lg" justify="flex-end">
            ...
            <Button onClick={stack.closeAll} color="red-dev-dev">
              Confirm
            </Button>
          </Group>
        </Modal>
